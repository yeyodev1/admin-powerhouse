  ...
  <div class="auth-view">
    ...
    <div class="auth-card">
      <div class="auth-card__header">
        ...
        <p class="auth-card__subtitle">Accede a tu cuenta de administración</p>
      </div>
      ...
      <div class="auth-card__footer">
        <p>¿No tienes cuenta? <router-link to="/register" class="auth-link">Solicitar acceso</router-link></p>
      </div>
    </div>
  </div>
</template>
